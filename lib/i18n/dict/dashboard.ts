export const dashboard = {
  en: {
    ...
    account: {
      ...
      hint: "A confirmed address is what lets you set a new password if you lose this one.",
      verified: "Confirmed",
  ...
  tr: {
    ...
    account: {
      ...
      hint: "Şifreni kaybedersen yenisini belirlemeni sağlayan şey doğrulanmış bir adrestir.",
      verified: "Doğrulandı",
