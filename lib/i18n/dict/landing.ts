export const landing = {
  en: {
    ...
    browse: {
      ...
      spells: "Spells",
      spellsBody: "319 spells from the SRD, filtered by level, class, school, and subclass.",
      monsters: "Monsters",
      monstersBody: "334 stat blocks with free artwork, filtered by challenge rating.",
  ...
  tr: {
    ...
    browse: {
      ...
      spells: "Büyüler",
      spellsBody: "SRD'den 319 büyü; seviye, sınıf, okul ve alt sınıfa göre filtrelenir.",
      monsters: "Canavarlar",
      monstersBody: "334 stat bloğu, özgür lisanslı görsellerle; CR'a göre filtrelenir.",
